...
const SidebarItem = ({
  ...
  return (
    <div className="transition-all duration-500">
      <div
        className={`flex transition-all duration-500 items-center p-3 rounded-lg hover:bg-sidebar-background cursor-pointer ${
          color.primaryText
        } hover:text-white justify-between
    ...
    `}
      ...
      <div
        className={`overflow-hidden transition-all duration-500 flex ${
          expanded ? `h-[calc(${30 * item?.length}px)]` : 'h-0'
        }`}
      >
        <div
